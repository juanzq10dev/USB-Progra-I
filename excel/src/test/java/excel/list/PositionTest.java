...
public class PositionTest {
    ...
    @Test
    public void testPositionXShouldReturnTwentySixForZ() {
        Position position = new Position('z', 10);
        Position position2 = new Position('Z', 10);
        int result = position.obtainTransformedPositionX();
        int expected = 25;
        assertEquals(expected, result);
        result = position2.obtainTransformedPositionX();
        assertEquals(expected, result);
    }
    ...
    public void testObtainPositionYShouldReturnTwentyForTwentyOne() {
        ...
        int result = position.obtainTransformedPositionY();
        int expected = 20;
        assertEquals(expected, result);
    }
}
